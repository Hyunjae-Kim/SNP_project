...
lasso_list = [0.0005, 0.005, 0.05, 0.1, 0.3]
lasso_list2 = [0.0005, 0.001, 0.003, 0.005, 0.01, 0.03]
if model_num<6:
    base_node = 128
    lasso_alpha = lasso_list[model_num-1]
elif model_num >=6 and model_num<11:
    base_node = 64
    lasso_alpha = lasso_list[model_num-6]
elif model_num>=11:
    base_node = 256
    lasso_alpha = lasso_list2[model_num-11]
...
print('Option : Lasso alpha / # of base nodes : %.4f / %d'\
      %(lasso_alpha, base_node))
