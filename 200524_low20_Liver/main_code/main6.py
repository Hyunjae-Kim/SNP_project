...
ch_list = [8, 16]
lasso_list = [0.03, 0.3]
lasso_alpha = lasso_list[int((model_num-1)/2)]
n_channel = ch_list[model_num-1-int((model_num-1)/2)*2]
...
model = nn.DataParallel(Model(snp_len=snp_len, n_channel=n_channel)).to(device)
